      ...
      <headerya text="新增标签" @search="search" @clear="clear" @add="add">
        <template #input1>
          <el-form-item label="标签名称">
            <el-input v-model.trim="pages.tagName"></el-input>
          </el-form-item>
        </template>
        <template #input2>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, data) {
      ...
      this.$refs.add.form.tagName = data.tagName;
    },
